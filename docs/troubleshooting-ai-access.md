...
| **AI บอกเสร็จแต่ไม่มีของ** | โมเดลแต่งรายงานความสำเร็จ (เจอจริง: อ้าง "commit 4 ไฟล์" ทั้งที่ dir ว่าง) | **อย่าเชื่อจนเห็น test ผ่าน + `git log` ด้วยตาตัวเอง** — ดู `docs/ai-employee-manual.md` |
