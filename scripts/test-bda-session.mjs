...
assert.match(help.stdout, /bda-session\/0\.11\.7/);
...
assert.equal(versionJson.cli_version, "0.11.7");
...
assert.equal(installerDryRunJson.installer_version, "installer/0.11.7");
...
assert.equal(updateJson.inventory_send_result.event.bda_cli_version, "0.11.7");
