...
User-facing QA/product evidence command that wraps `core/commands/test-scenario-report.md`, `core/workflows/test-scenario-report.md`, and `core/templates/test-scenario-report.md`.
...
- Detailed command: `core/commands/test-scenario-report.md`
- Workflow: `core/workflows/test-scenario-report.md`
- Template: `core/templates/test-scenario-report.md`
- Claude Code slash alias: `/test-report` จาก `channels/llm-local/claude/commands/test-report.md`
...
โปรดทำตามขั้นตอนนี้:
1. อ่าน `core/commands/test-report.md`, standard `core/commands/test-scenario-report.md`, `core/workflows/test-scenario-report.md`, และ `core/templates/test-scenario-report.md`
2. ยืนยัน scope ว่าเป็น QA/product evidence ไม่ใช่ performance evaluation
...
10. สร้างรายงาน Markdown จาก `core/templates/test-scenario-report.md` พร้อม test matrix, Auth/RBAC matrix, route source trace, route drift/SPA 404 check, pass/fail/blocked/not run, blocked reason taxonomy, evidence manifest, severity, recommendations, limitations
...
- [ ] Scope เป็น QA/product evidence ไม่ใช่ performance
...
1. **BDA Standard files used** — ระบุ path เช่น `core/commands/test-report.md`, `core/commands/test-scenario-report.md`, `core/workflows/test-scenario-report.md`, `core/templates/test-scenario-report.md`
