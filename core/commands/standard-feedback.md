...
6. ถ้าจะสร้าง issue/PR ให้ใช้ core/templates/standard-feedback.md
...
1. **BDA Standard files used** — ระบุ path ของไฟล์มาตรฐาน BDA ที่เปิด/อ้างอิงจริง เช่น `FEEDBACK.md`, `core/commands/standard-feedback.md`, `core/workflows/standard-improvement.md`, `core/templates/standard-feedback.md`, `STANDARD.md`, `UPDATE-POLICY.md`
