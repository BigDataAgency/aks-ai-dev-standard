...
โปรดทำตามขั้นตอนนี้:
1. ถ้ามี Obsidian context manifest (`00-Agent-Context.md` หรือ `.bda/obsidian-context.md`) ให้อ่านก่อนเลือกที่เก็บเอกสาร; ถ้าไม่มีและงานต้องผูกกับ Obsidian ให้ใช้ `core/commands/init.md`
2. กำหนด audience
