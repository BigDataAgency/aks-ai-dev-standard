...
## Private report ingest connector (dry-run default)

`scripts/send-ingest-report.mjs` converts a Test Report / test-scenario-report markdown or JSON file into a minimal `bda-standard-ingest/0.4.1` `report_summary` payload.
...
- Staff SOP: `docs/staff-report-sender-sop.md`; staff command: `commands/send-report.md`.
